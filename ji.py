...
# Load the dataset
file_path = "C:/Users/ConnorChristensen/OneDrive - Wyoming Business Council/Documents/GitHub/Justice-Involved/Master Phase 3 Data - 1-7-25 - Master.csv"
ji = pd.read_csv(file_path)

for col in sorted(ji.columns):
    print(col)
